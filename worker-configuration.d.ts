/* eslint-disable */
// Generated by Wrangler by running `wrangler types /workspace/sites/fitspace/worker-configuration.d.ts --config /tmp/fitspace-type-config.json` (hash: 2f329b3a977cad3a79506068330b7a6f)
